...
export default function SecurityHero() {
  return <div className="flex flex-col md:flex-row items-center gap-6">
      <motion.div initial={{
      opacity: 0,
      x: -20
    }} animate={{
      ...
      duration: 0.6
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">Veiligheid</h1>
