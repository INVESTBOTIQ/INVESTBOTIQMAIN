  ...
  return (
    <section className="relative z-10 w-full flex flex-col md:flex-row min-h-[81vh] md:min-h-[70vh] lg:min-h-[72vh] pt-24 md:pt-32 bg-transparent">
      <div className="flex-1 flex flex-col items-center md:items-start justify-center px-5 sm:px-10 lg:pl-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-5 mt-2 mb-7 w-full md:w-auto">
          ...
          <FadeIn delay={0.42}>
            <Button
              variant="outline"
              className="w-72 max-w-full md:w-56 text-lg py-6 px-6 font-semibold border bg-white/80 backdrop-blur-sm text-indigo-600 shadow-lg border-indigo-200 hover:bg-indigo-50 hover:text-indigo-800 transition-all duration-300 rounded-xl"
      ...
      <div className="flex-1 flex flex-col justify-center items-center relative mt-10 md:mt-0">
        ...
        <FadeIn delay={0.34}>
          <div className="mt-8 md:mt-14 text-indigo-800 font-semibold text-lg sm:text-xl text-center max-w-xs mx-auto">
